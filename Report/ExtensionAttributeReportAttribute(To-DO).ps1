...
$FilteredGroups = $ALLGroups | Where-Object { $_.Description -like '*Attribute*' -or $_.DisplayName -like '*Winget*' -or $_.DisplayName -like '*Attribute*' -or $_.DisplayName -like '*Remediation*'}
