...
$Paris = New-Object System.Management.Automation.Host.ChoiceDescription '&Paris' , 'Remove from ParisDL'
$Lyon = New-Object System.Management.Automation.Host.ChoiceDescription '&Lyon' , 'Remove from LyonDL'
$Mumbai = New-Object System.Management.Automation.Host.ChoiceDescription '&Mumbai' , 'Remove from MumbaiDL'
...
ForEach ($DL in $DLs) {
     Try {
      ...
      Catch {
       ...
       Else
       {
        Write-Host $User -ErrorAction Continue -ForegroundColor Red
       }
}
