...
$inputFilePath = "C:\Test\Only-IT-Finance-Direction.csv"
$outputFilePath = "C:\Users\GregorySemedo\Desktop\Only-IT-Finance-Direction.csv"
$sharedMailboxFilePath = "C:\Users\GregorySemedo\Desktop\SharedMailboxOnly-IT-Finance-Direction.csv"
...
$UserList = Import-Csv -Path "C:\Test\Only-IT-Finance-Direction-SharedMailbox.csv"
