...
$inputFilePath = "C:\Test\AllOperations.csv"
$outputFilePath = "C:\Users\GregorySemedo\Desktop\Only-Operations.csv"
$sharedMailboxFilePath = "C:\Users\GregorySemedo\Desktop\SharedMailboxOnly-Operations.csv"
...
$UserList = Import-Csv -Path "C:\Test\Only-Operations-SharedMailbox.csv"
