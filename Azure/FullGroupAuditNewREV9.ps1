...
$inputFilePath = "C:\Test\Only-Consulting.csv"
$outputFilePath = "C:\Users\GregorySemedo\Desktop\Only-Consulting.csv"
$sharedMailboxFilePath = "C:\Users\GregorySemedo\Desktop\SharedMailboxOnly-Consulting.csv"
