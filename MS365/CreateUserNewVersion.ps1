...
$Password = Read-Host -Prompt "Enter the password of the user to add" -AsSecureString
# Create a new user
New-MsolUser -DisplayName $Displayname -FirstName $Fname -LastName $Lname -UserPrincipalName $Username -Department $Department -ForceChangePassword $true -Password $Password -ErrorAction SilentlyContinue 
