...
$Office.HelpMessage = 'Add Teams Office'
$Paris = New-Object System.Management.Automation.Host.ChoiceDescription '&Paris' , 'Add Teams Paris'
$Lyon = New-Object System.Management.Automation.Host.ChoiceDescription '&Lyon' , 'Add Teams Lyon'
$Quit = New-Object System.Management.Automation.Host.ChoiceDescription '&Quit' , 'Quit'
$options = [System.Management.Automation.Host.ChoiceDescription[]]($Paris, $Lyon, $Quit)
