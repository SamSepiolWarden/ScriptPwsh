...
{Remove-TeamUser -GroupId b2e6ef79-7d1d-4e72-b027-fb8caa25202a -User $User -Role Member}
if($Location -eq 'Paris')
{
...
If($Location -eq 'Lyon') 
{Remove-TeamUser -GroupId b7e7d611-2ec3-479e-afec-bcedb0aadfb4 -User $User -Role Member}
if($Location -eq 'Lyon')
{
Write-Host $User Succesfully remove -ForegroundColor Green
}
