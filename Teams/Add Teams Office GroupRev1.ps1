...
Get-TeamUser -GroupId b2e6ef79-7d1d-4e72-b027-fb8caa25202a | Select-Object User | Where-Object {$_.User -eq $User}
if($? -eq $true)
...
Get-TeamUser -GroupId b7e7d611-2ec3-479e-afec-bcedb0aadfb4 | Select-Object User | Where-Object {$_.User -eq $User}
if($? -eq $true)
